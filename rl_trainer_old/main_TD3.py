...
def main(args):
    ...
    while episode < args.max_episodes:
        ...
        while True:
            ...
            logits = model.choose_action(obs)+1
            #print("logits",logits)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_episodes', default=4000, type=int) #50000
    parser.add_argument('--episode_length', default=200, type=int)
    parser.add_argument('--output_activation', default="softmax", type=str, help="tanh/softmax")

    parser.add_argument('--buffer_size', default=int(1e5), type=int) #6e4
    parser.add_argument('--tau', default=0.1, type=float) #0.08
    parser.add_argument('--gamma', default=0.9, type=float) #0.95
    parser.add_argument('--seed', default=1, type=int)
    parser.add_argument('--a_lr', default=0.001, type=float)#0.0001
